    ...
    <div class = 'profile-img-name'>
      ...
      <div id = 'profile-image'>
        <div class="profile-photo">
          <img id="img-profile" class="photo" src=" ">
        </div>
    ...
    <div class = 'profile-aboutme'>
      <div id = 'profile-description'>
        ...
        <div class="title-description">
          <p class="description">¡Hola! Me gusta programar, comer pizza y mirar películas.
          Mis lenguajes favoritos son JavaScript, Pyton, Php  y C++</p>
        </div>
      </div>
      ...
      <div id = 'profile-links'>
        ...
        <div class ="title-links">
          <p class="links"> Mis redes sociales</p>
        </div>
      </div>
...
`;
  ...
  const contentMainProfile = `
     <div id="aside-left">
        <ul>
          ...
          <div class="frase-favorita" id = 'favorite-phrase'>
            <p class="frase">"Si se puede imaginar, se puede programar".</p>
          </div>
        </ul>
    </div> 
    ...
    <div class="aside-profile-mobile">
        <ul>
          <li><a href="http://xxxx"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-heading" viewBox="0 0 16 16">
          ...
          <li><a href="http://x"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-paperclip" viewBox="0 0 16 16">
