...
export const navLeft = () => {
  ...
  const template = `
  <ul>
    <li><a href="#"  id="navAliadas"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
    ...
    <li><a href="#" id="navPost"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filter-square-fill" viewBox="0 0 16 16">
    ...
    <li><a href="#" id="navPhrase"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
  ...
  /* Botón para Aliadas */
  const navAliadas = container.querySelector('#navAliadas');
  ...
  /* Botón para Post */
  const navPost = container.querySelector('#navPost');
  ...
  /* Botón para Mi Frase */
  const navPhrase = container.querySelector('#navPhrase');
